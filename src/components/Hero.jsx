...
const Hero = () => {
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center px-4 overflow-hidden bg-black">      
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
        ...
        >
          ...
          <motion.p
            ...
            variants={item}
          >
            Transforming ideas into digital reality. We craft cutting-edge
          ...
          >
            ...
            {/* Button 2 - Transparent Border Style */}
            <motion.div variants={buttonItem} whileHover="hover" whileTap="tap">
              <button
                onClick={() => {
